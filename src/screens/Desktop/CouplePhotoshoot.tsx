...
export const CouplePhotoshoot = (): JSX.Element => {
  return (
    <section id="couplephotoshoot" className="py-22 bg-[#5e8c48] overflow-hidden w-full lg:min-w-[1440px] min-h-[813.69px] lg:min-h-[813.69px] md:min-h-[600px] min-h-[500px] relative flex flex-col md:block">
      {/* First image */}
      <div
      ...
      />
      {/* Second image */}
      <div className="lg:absolute md:absolute relative top-[0px] lg:top-0 md:top-0 left-0 pr-32 lg:left-[336px] md:left-[200px] w-full lg:w-[1133px] md:w-[calc(100%-200px)] h-[300px] lg:h-[552px] md:h-[380px] bg-[url(/frame-59.png)] bg-cover bg-center" />
      ...
      <section className="absolute lg:top-[645px] md:top-[450px] top-[340px]  w-full lg:h-[135px] md:h-[100px] h-[80px] flex bg-white overflow-hidden items-center justify-center lg:justify-start px-4">
        <h1 className="lg:mt-[22px] mt-0 lg:w-[853px] w-auto lg:h-[132px] h-auto lg:ml-[518px] ml-0 [font-family:'Mirza',Helvetica] font-normal text-black lg:text-[110px] md:text-[60px] text-[36px] tracking-[0] leading-[normal] lg:whitespace-nowrap whitespace-normal text-center lg:text-left">
          Couple Photoshoots
        </h1>
      </section>
