...
export const HalfSaree = (): JSX.Element => {
  return (
    <div className="overflow-hidden bg-black w-full h-[813px] flex md:items-center justify-center">
      <div className="w-full max-w-[1440px] h-auto md:h-[814px] relative bg-black">
        ...
        <div className="absolute bottom-4 md:top-[693px] left-28 md:left-[437px] right-4 md:w-[1003px] md:h-[171px] flex justify-center md:justify-start z-10">
          <h1
        ...
        <div className="hidden md:block absolute top-[100px] md:top-[625px] left-[250px] w-full md:w-[1191px] h-[100px] md:h-[187px] bg-[#908b83] opacity-70" />
        {/* <div className=" absolute bottom-4 md:top-[643px] left-4 md:left-[577px] right-4 md:w-[1003px] md:h-[171px] flex justify-center md:justify-start z-10">
          <div className="relative inline-block">
            <div className="absolute inset-0 bg-[#908b83] opacity-70 -z-10 rounded-md" />
            <h1 className="font-['Helvetica',poppins] font-light text-[#fefefe] text-[32px] md:text-[64px] tracking-[0] leading-tight md:leading-[normal] text-center md:text-left px-4 md:px-6">
              HALF SAREE CEREMONY
            </h1>
          </div>
        </div> */}
